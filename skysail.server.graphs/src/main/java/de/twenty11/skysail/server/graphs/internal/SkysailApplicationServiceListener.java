 ...
 * 
 */
public class SkysailApplicationServiceListener implements ServiceListener, GraphModelProvider {
    ...
    private Map<ApplicationDescriptor, GraphsModel> appToForms = new HashMap<ApplicationDescriptor, GraphsModel>();
    ...
    public SkysailApplicationServiceListener(final BundleContext context) {
        ...
        try {
            ...
            GraphsSkysailApplication.setFormModelProvider(this);
