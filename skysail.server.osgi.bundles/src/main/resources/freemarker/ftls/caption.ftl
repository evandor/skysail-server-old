        <caption>
          ...
          <#else>
            <li class="previous"><a href="${request}page=${page-1}">«Previous</a></li>
          </#if>
          ...
          <#list 1..pages as i>
              ...
              <#else>
                <li class="next"><a title="${request}" href="${request}page=${i}">${i}</a></li>
              </#if>
          </#list>
          ...
          <#else>
            <li class="next"><a href="${request}page=${page+1}">Next »</a></li>
          </#if>
