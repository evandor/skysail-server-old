...
// public class MemoryAppender extends AppenderBase<ILoggingEvent> {
//
// private static HashMap<String, LimitedLinkedHashMap<Integer, ILoggingEvent>>
// loggerMaps = new LinkedHashMap<String, LimitedLinkedHashMap<Integer,
// ILoggingEvent>>();
//
// private static AtomicInteger i = new AtomicInteger(0);
//
// // FIXME for tests as log as i dont get pax exam to work properly
// public static void appendForTests(ILoggingEvent event) {
// new MemoryAppender().append(event);
// }
//
// @Override
// public void append(ILoggingEvent event) {
...
// bundleLog = loggerMaps.get(bundleName);
// } else {
// bundleLog = new LimitedLinkedHashMap<Integer, ILoggingEvent>(3);
// loggerMaps.put(bundleName, bundleLog);
// }
...
// }
//
// public LimitedLinkedHashMap<Integer, ILoggingEvent> getLogForBundle(final
// String bundleName) {
// return loggerMaps.get(bundleName);
// }
//
...
// }
// Set<String> result = new HashSet<String>();
// LimitedLinkedHashMap<Integer, ILoggingEvent> limitedLinkedHashMap =
// loggerMaps.get(logname);
// SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSZ");
// for (Integer nr : limitedLinkedHashMap.keySet()) {
// ILoggingEvent e = limitedLinkedHashMap.get(nr);
// String line = new StringBuffer().append(nr + " [").append(sdf.format(new
// Date(e.getTimeStamp()))).append("]: ").append(e.toString()).toString();
// result.add(line);
// }
// return result;
// }
