...
public class CheckBusinessViolationsFilterTest {
    ...
    public void should_fail_for_simpleEntity_without_name() {
        ...
        CheckBusinessViolationsFilter<UniqueResultServerResource<SimpleEntity>, SimpleEntity> filter = new CheckBusinessViolationsFilter<UniqueResultServerResource<SimpleEntity>, SimpleEntity>();
    ...
    public void should_fail_for_simpleEntityList_without_name() {
        ...
        CheckBusinessViolationsFilter<ListServerResource<SimpleEntity>, List<SimpleEntity>> filter = new CheckBusinessViolationsFilter<ListServerResource<SimpleEntity>, List<SimpleEntity>>();
