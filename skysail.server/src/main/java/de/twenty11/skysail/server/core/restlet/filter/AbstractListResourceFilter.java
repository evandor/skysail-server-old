...
public abstract class AbstractListResourceFilter<T> implements ListResourceFilter<T> {
     ...
     */
    public final ResponseWrapper<T> handle(ListServerResource<T> resource, Request request) {
     ...
     */
    public final void handle(ListServerResource<T> resource, Request request, ResponseWrapper<T> response) {
    ...
    public AbstractListResourceFilter<T> calling(AbstractListResourceFilter<T> next) {
