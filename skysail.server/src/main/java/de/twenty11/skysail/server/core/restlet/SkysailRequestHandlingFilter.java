...
public abstract class SkysailRequestHandlingFilter<T> {
     ...
     */
    public final ResponseWrapper<T> handle(ListServerResource2<T> resource, Request request) {
     ...
     */
    public final void handle(ListServerResource2 resource, Request request, ResponseWrapper response) {
